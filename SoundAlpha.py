...
class mywindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.comboBox.addItem("alphavillesounds_like_a_melody.mp3")
        self.ui.comboBox.addItem("Alphaville_Sounds_Like_A_Melody.mp3")
        self.ui.comboBox.setCurrentText("alphavillesounds_like_a_melody.mp3")
        self.stoped=True
        pygame.init()
