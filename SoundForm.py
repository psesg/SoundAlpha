...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_PlaySelected.setGeometry(QtCore.QRect(10, 140, 221, 23))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_PauseCont.setGeometry(QtCore.QRect(10, 200, 221, 23))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.horizontalSlider.setGeometry(QtCore.QRect(10, 240, 221, 22))
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.horizontalSliderPos = QtWidgets.QSlider(self.centralwidget)
        self.horizontalSliderPos.setGeometry(QtCore.QRect(10, 270, 221, 22))
        ...
        self.label_vol.setGeometry(QtCore.QRect(10, 230, 221, 20))
        font = QtGui.QFont()
        ...
        self.label_pos.setGeometry(QtCore.QRect(10, 260, 221, 20))
        font = QtGui.QFont()
        font.setFamily("Courier New")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.pushButton_PlayAll.setGeometry(QtCore.QRect(10, 170, 221, 23))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_cursong.setGeometry(QtCore.QRect(10, 40, 221, 20))
        font = QtGui.QFont()
        font.setFamily("Arial Narrow")
        font.setPointSize(8)
        ...
        self.plainTextEdit_start_dir.setGeometry(QtCore.QRect(10, 70, 221, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Narrow")
        font.setPointSize(6)
        ...
        self.pushButton_Choose.setGeometry(QtCore.QRect(10, 100, 221, 23))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
